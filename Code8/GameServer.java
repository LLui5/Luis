...
{  private GameServerWork players[] = new GameServerWork[100];
   ...
   //--
   for (int i = 0; i < playerCount; i++)
        players[i].send("k"+order+":"+players[order].x+":"+players[order].y+":"+seconds+":"+puntos+":"+listn[0].x+":"+listn[0].y+":"+listn[0].value+":"+listn[1].x+":"+listn[1].y+":"+listn[1].value+":"+listn[2].x+":"+listn[2].y+":"+listn[2].value+":"+listn[3].x+":"+listn[3].y+":"+listn[3].value+":"+operationr+":"+operationa+":"+operationb);			    
...
class Listgamenumber{
	...
	class MyTimer implements Runnable{
		...
		public void run(){
			while(true){
				for (int i = 0; i < playerCount; i++)
				players[i].send("k"+0+":"+players[0].x+":"+players[0].y+":"+seconds+":"+puntos+":"+listn[0].x+":"+listn[0].y+":"+listn[0].value+":"+listn[1].x+":"+listn[1].y+":"+listn[1].value+":"+listn[2].x+":"+listn[2].y+":"+listn[2].value+":"+listn[3].x+":"+listn[3].y+":"+listn[3].value+":"+operationr+":"+operationa+":"+operationb);			    
